        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        <!-- Drag & Drop Area -->
                        <div class="border-2 border-dashed border-primary-300 rounded-xl p-8 text-center hover:border-primary-400 transition-standard" id="dropZone">
                            <svg class="w-12 h-12 text-primary mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                            </svg>
                            <h3 class="text-lg font-medium text-primary mb-2">Arrastra tu archivo aquí</h3>
                            <p class="text-text-secondary mb-4">o haz clic para seleccionar</p>
                            <button class="btn-primary" onclick="document.getElementById('fileInput').click()">
                                Seleccionar Archivo
                            </button>
                            <input type="file" id="fileInput" accept=".pdf,.docx" class="hidden" onchange="handleFileSelect(this)">
                            <p class="text-xs text-text-secondary mt-3">Formatos: PDF, DOCX ? Máximo 50MB</p>
                        </div>

                        <!-- File Version History -->
                        <div class="mt-6">
                            <h3 class="text-sm font-medium text-primary mb-3">Historial de Versiones</h3>
                            <div class="space-y-2">
                                <div class="flex items-center justify-between p-3 bg-primary-50 border border-primary-200 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-primary">tesis_v2_final.pdf</p>
                                            <p class="text-xs text-text-secondary">2.4 MB ? 02 Nov 2025, 14:30</p>
                                        </div>
                                    </div>
                                    <span class="text-xs bg-primary text-white px-2 py-1 rounded-full">Actual</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-600">tesis_v1_borrador.pdf</p>
                                            <p class="text-xs text-text-secondary">2.1 MB ? 25 Oct 2025, 09:15</p>
                                        </div>
                                    </div>
                                    <button class="text-xs text-primary hover:underline">Descargar</button>
                                </div>
                            </div>
                        </div>
                    </div>
